...
public class NewProcessView extends javax.swing.JDialog {
    ...
    ArrayList<String> titolsProcesos;
    String titol = "";
     ...
     */
    public NewProcessView(ArrayList<String> titols, int cas, String strTitol) {
    ...
    public NewProcessView(ArrayList<String> titols) {
        this.setModal(true);
        initComponents();
        titolsProcesos = titols;
        this.setTitle(Constants.tituloNewProces);
...
// cogemos la descripci�n
        ...
        } else //comprovar que la descrip. del proces no estigui repetit
